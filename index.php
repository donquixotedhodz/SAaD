...
<head>
    ...
    <style>
        ...
        .hero {
            ...
            height: 100vh;
            min-height: 700px;
            /* Update hero background image - place a hero image (1920x1080px recommended) in images folder */
            background: url('images/hotel-bg.jpg') center/cover no-repeat;
            margin-top: -56px;
        }
        .hero-overlay {
            position: absolute;
...
/* Room Cards */
/* Replace the existing room-card related styles with these */
.room-card {
